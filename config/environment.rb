...
Rails::Initializer.run do |config|
  ...
  raise "ENV variable RAILS_SESSION_KEY is not set" unless ENV["RAILS_SESSION_KEY"]
  config.action_controller.session = { :key => "_chiliproject_session", :secret => ENV["RAILS_SESSION_KEY"] }
end
